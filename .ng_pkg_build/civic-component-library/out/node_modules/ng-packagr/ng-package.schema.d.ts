...
export interface NgPackageConfig {
    ...
    lib?: {
        ...
        /**
         * Use "all" to keep all, or "none" to remove all the comments or or regexes
         */
        comments?: string;
        /**
         * Licesnse file path to repend to the bundles
         */
        licensePath?: string;
        /**
        ...
        cssUrl?: "none" | "inline";
        /**
         * Any additional paths that should used to resolve SASS imports
         */
